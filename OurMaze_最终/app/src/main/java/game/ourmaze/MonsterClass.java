...
public class MonsterClass {
	static class Monster{
		...
		public Monster(int sx,int sy,int mon_id){
			x=sx; y=sy; 
			wisedom=Data.mon_pro[mon_id][0]*(ManClass.man.level+1); blood=Data.mon_pro[mon_id][1]*(ManClass.man.level+1); defence=Data.mon_pro[mon_id][2]*(ManClass.man.level+1); beat=Data.mon_pro[mon_id][3]*(ManClass.man.level+1); 
