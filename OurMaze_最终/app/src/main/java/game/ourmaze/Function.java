	...
	public  static boolean fight_flag=true;
		public static void fight(int mon_id){
			...
			while(ManClass.man.blood!=0 && MonsterClass.monster[mon_id].blood!=0){
				if(fight_flag)
				ManClass.man.blood-=d_man; MonsterClass.monster[mon_id].blood-=d_mon;
		...
		//	Data.y_man_move_time_state;
	    	...
	    	if(Data.place_x<-((Data.maze_a)*Data.unit_l-Data.scr_width))Data.place_x=-((Data.maze_a)*Data.unit_l-(Data.scr_width));
	    	if(Data.place_y<-((Data.maze_b)*Data.unit_l-Data.scr_height))Data.place_y=-((Data.maze_b)*Data.unit_l-Data.scr_height);
	    	
	    	
	    ////man place 
	    	if(Data.place_y<-(ManClass.man.y-2)*Data.unit_l)Data.place_y=-(ManClass.man.y-2)*Data.unit_l;
	    	if(Data.place_x<-(ManClass.man.x-2)*Data.unit_l)Data.place_x=-(ManClass.man.x-2)*Data.unit_l;
	    	if(Data.place_y>Data.scr_height-(ManClass.man.y+1)*Data.unit_l)Data.place_y=Data.scr_height-(ManClass.man.y+1)*Data.unit_l;
	    	if(Data.place_x>Data.scr_width-(ManClass.man.x+1)*Data.unit_l)Data.place_x=Data.scr_width-(ManClass.man.x+1)*Data.unit_l;
...
class sleep extends Thread
{
	...
	private int flag;
	public sleep(int st,int flag){sleep_time=st;this.flag=flag;}
	public void run()
	{
			if(flag==1)
			{
